...
dummy_pkl_path = os.path.join(_PROJECT_ROOT, "_test_dummy_data.pkl")
...
def run_validation_subprocess(policy_code, label):
    ...
    test_code = file_to_string(os.path.join(_PROJECT_ROOT, "tests", "test_generate_policy.py"))
    full = head + policy_code + "\n\n" + test_code

    tmp_path = os.path.join(_PROJECT_ROOT, f"_test_temp_{label}.py")
